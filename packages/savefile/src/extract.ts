 ...
 */
const extractObject = (object: TTSObject, path: PathLike, options: Options) => {
...
const extractScripts = (object: TTSObject | SaveFile, path: PathLike) => {
    if (object.LuaScript) {
...
const extractContent = (objects: TTSObject[], path: PathLike, options: Options) => {
...
const extractStates = (object: TTSObject, path: PathLike, options: Options) => {
    if (object.States) {
...
const extractData = (object: TTSObject | SaveFile, path: PathLike, normalize: boolean = false) => {
    if (normalize) {
